		...
		<div class="bitslab-price-table-widget <?= $type ?>">
			<div class="bitslab-price-table-wrap">
				...
				<div class="bitslab-price-table-price">
					<div class="bitslab-price-table-price-t"><?= $price ?></div>
				...
				<div class="bitslab-price-table-footer">
					...
					if ($isuserlogged_in) {
						...
						//echo "<pre>";print_r($user_roles[0]);die;
					...
					//$showEntriesFrontEnd; //(!empty($showEntriesFrontEnd)) ? $showEntriesFrontEnd : $ListUserFirstSubs;
		    		
					//if ($maxjoinuser <= count($args_user)) { 
						//if(in_array($currentUserId, $args_user)){
						// echo $currentUserId;
						// echo "<pre>";print_r($showEntriesFrontEnd_aray);

						

						// echo $showEntriesFrontEnd;
				...
				<?php }elseif ($user_roles[0]=='one-time') {
				...
				// if (true || $valueStock > $showEntriesFrontEnd) {
